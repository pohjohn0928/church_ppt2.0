 ...
 */
        ...
        const yt = (t, e, i) => _t(t, i, (s => t[s][e] < i))
            , vt = (t, e, i) => _t(t, i, (s => t[s][e] >= i));
        ...
        const Mt = ["push", "pop", "shift", "splice", "unshift"];
        ...
        function Ft(t) {
            ...
            t = Wt(t, e, t / 1e3) ? e : t;
            const i = Math.pow(10, Math.floor(It(t)))
                , s = t / i;
        ...
        const le = t => Math.round(10 * t) / 10;

        function he(t, e, i, s) {
            const n = se(t)
                , o = ae(n, "margin")
                , a = ie(n.maxWidth, t, "clientWidth") || At
                , r = ie(n.maxHeight, t, "clientHeight") || At
                , l = function (t, e, i) {
                let s, n;
            ...
            return h = Math.max(0, h - o.width),
                ...
                h = le(Math.min(h, a, l.maxWidth)),
                c = le(Math.min(c, r, l.maxHeight)),
            h && !c && (c = le(h / 2)),
                {
                    width: h,
                    height: c
        ...
        function fe(t, e, i, s) {
            ...
            if (r && e === r.axis && "r" !== e && a && o.length) {
                const t = r._reversePixels ? vt : yt;
                if (!s)
                    return t(o, e, i);
                if (n._sharedOptions) {
                    const s = o[0]
        ...
        function pe(t, e, i, s) {
            const n = [];
            if (!t.isPointInArea(e))
                return n;
            return ge(t, i, e, (function (t, i, o) {
        ...
        function xe(t, e, i, s, n) {
            return t.isPointInArea(e) ? "r" !== i || s ? me(t, e, i, s, n) : function (t, e, i, s) {
                let n = [];
                return ge(t, i, e, (function (t, i, o) {
        ...
        var _e = {
            ...
            modes: {
                index(t, e, i, s) {
                    const n = re(e, t)
                        , o = i.axis || "x"
                        , a = i.intersect ? pe(t, n, o, s) : xe(t, n, o, !1, s)
                        , r = [];
                ...
                dataset(t, e, i, s) {
                    const n = re(e, t)
                        , o = i.axis || "xy";
                    let a = i.intersect ? pe(t, n, o, s) : xe(t, n, o, !1, s);
                    if (a.length > 0) {
                ...
                point: (t, e, i, s) => pe(t, re(e, t), i.axis || "xy", s),
                nearest: (t, e, i, s) => xe(t, re(e, t), i.axis || "xy", i.intersect, s),
                x: (t, e, i, s) => be(t, re(e, t), "x", i.intersect, s),
                y: (t, e, i, s) => be(t, re(e, t), "y", i.intersect, s)
            }
        };
                ...
                switch (t.beginPath(),
                    ...
                    case "rectRounded":
                        l = .516 * d,
                            ...
                            o = Math.cos(u + Rt) * r,
                            a = Math.sin(u + Rt) * r,
                            t.arc(i - o, s - a, l, u - Dt, u - Lt),
                            t.arc(i + a, s - o, l, u - Lt, u),
                            t.arc(i + o, s + a, l, u, u + Lt),
                            t.arc(i - a, s + o, l, u + Lt, u + Dt),
                            t.closePath();
                        break;
                    case "rect":
                        if (!c) {
        ...
        function Re(t, e) {
            ...
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, -Lt, Dt, !0),
                t.lineTo(i, s + o - a.bottomLeft),
                t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, Dt, Lt, !0),
                t.lineTo(i + n - a.bottomRight, s + o),
                t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, Lt, 0, !0),
        ...
        function Ne(t, e) {
            ...
            s && !("" + s).match(Ie) && (console.warn('Invalid font style specified: "' + s + '"'),
                s = "");
            const n = {
                family: K(t.family, e.family),
                lineHeight: ze(K(t.lineHeight, e.lineHeight), i),
                size: i,
                style: s,
                weight: K(t.weight, e.weight),
                string: ""
            };
            return n.string = ye(n),
                n
        }
        ...
        const Ye = ["left", "top", "right", "bottom"];
        ...
        function Xe(t, e) {
            return t.filter((t => -1 === Ye.indexOf(t.pos) && t.box.axis === e))
        }
        ...
        function Je(t, e, i, s) {
            ...
            o.getPadding && Ze(a, o.getPadding());
            const r = Math.max(0, e.outerWidth - Ge(a, t, "left", "right"))
                , l = Math.max(0, e.outerHeight - Ge(a, t, "top", "bottom"))
                , h = r !== t.w
                , c = l !== t.h;
            return t.w = r,
                t.h = l,
        ...
        function ti(t, e, i, s) {
            ...
            for (o = 0,
                ...
                const {same: a, other: d} = Je(e, i, r, s);
                h |= a && n.length,
                    c = c || d,
                l.fullSize || n.push(r)
            }
            return h && ti(n, e, i, s) || c
        }
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    ...
                    ct(l.start) && (a = l.start),
                        t.fullSize ? ei(t, n.left, a, i.outerWidth - n.right - n.left, o) : ei(t, e.left + l.placed, a, s, o),
                        l.start = a,
                        l.placed += s,
                        a = t.bottom
                } else {
                    ...
                    ct(l.start) && (o = l.start),
                        t.fullSize ? ei(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ei(t, o, e.top + l.placed, a, s),
                        l.start = o,
                        l.placed += s,
                        o = t.right
                }
            ...
            update(t, e, i, s) {
                ...
                const n = We(t.options.layout.padding)
                    ...
                    const e = function (t) {
                        ...
                        , i = qe(e.filter((t => t.box.fullSize)), !0)
                        , s = qe(Ue(e, "left"), !0)
                        , n = qe(Ue(e, "right"))
                        , o = qe(Ue(e, "top"), !0)
                        , a = qe(Ue(e, "bottom"))
                ...
                ti(h, f, d, g) && ti(l, f, d, g),
                    ...
                    ii(r.leftAndTop, f, d, g),
                    f.x += f.w,
                    f.y += f.h,
                    ii(r.rightAndBottom, f, d, g),
                    t.chartArea = {
                        left: f.left,
                        top: f.top,
                        right: f.left + f.w,
        ...
        function ni(t, e = [""], i = t, s, n = (() => t[0])) {
            ct(s) || (s = pi("_fallback", t));
            const o = {
            ...
            return new Proxy(o, {
                deleteProperty: (e, i) => (delete e[i],
                    ...
                    delete t[0][i],
                    !0),
                get: (i, s) => hi(i, s, (() => function (t, e, i, s) {
                    let n;
                    for (const o of e)
                        if (n = pi(ri(o, t), i),
                            ct(n))
                            return li(t, n) ? fi(i, s, t, n) : n
                }(s, e, t, i))),
                getOwnPropertyDescriptor: (t, e) => Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
                getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
                has: (t, e) => mi(t).includes(e),
                ownKeys: t => mi(t),
                set(t, e, i) {
        ...
        function oi(t, e, i, s) {
            const n = {
                ...
                _stack: new Set,
                _descriptors: ai(t, s),
                setContext: e => oi(t, e, i, s),
                override: n => oi(t.override(n), e, i, s)
            };
            return new Proxy(n, {
                deleteProperty: (e, i) => (delete e[i],
                    delete t[i],
                    !0),
                get: (t, e, i) => hi(t, e, (() => function (t, e, i) {
                    ...
                    Y(r) && r.length && (r = function (t, e, i, s) {
                        ...
                        if (ct(o.index) && s(t))
                            ...
                            for (const l of i) {
                                const i = fi(s, n, t, l);
                                e.push(oi(i, o, a && a[t], r))
                            }
                        }
                        return e
                    }(e, r, t, a.isIndexable));
                    li(e, r) && (r = oi(r, n, o && o[e], a));
                    return r
                }(t, e, i))),
        ...
        const ri = (t, e) => t ? t + ht(e) : e
            ,
            li = (t, e) => U(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        ...
        const di = (t, e) => !0 === t ? e : "string" == typeof t ? lt(e, t) : void 0;
        ...
        function fi(t, e, i, s) {
            const n = e._rootScopes
                , o = ci(e._fallback, i, s)
                , a = [...t, ...n]
                , r = new Set;
            r.add(s);
            let l = gi(r, a, i, o || i, s);
            return null !== l && ((!ct(o) || o === i || (l = gi(r, a, o, l, s),
            null !== l)) && ni(Array.from(r), [""], n, o, (() => function (t, e, i) {
        ...
        function wi(t, e = "x") {
            ...
            for (a = 0; a < s; ++a)
                if (r = l,
                    ...
                    o[a] = r ? h ? zt(n[a - 1]) !== zt(n[a]) ? 0 : (n[a - 1] + n[a]) / 2 : n[a - 1] : n[a]
                }
            !function (t, e, i) {
                const s = t.length;
                ...
                for (let c = 0; c < s - 1; ++c)
                    l = h,
                        h = _i(t, c + 1),
                    l && h && (Wt(e[c], 0, bi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                        o = i[c + 1] / e[c],
        ...
        const Si = t => 0 === t || 1 === t
            , Pi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * Ct / i)
            , Di = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * Ct / i) + 1
            , Ci = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
            ...
            easeInOutSine: t => -.5 * (Math.cos(Dt * t) - 1),
        ...
        var Yi = Object.freeze({
            ...
            _bezierCurveTo: Ae,
            renderText: Te,
            addRoundedRectPath: Re,
            _lookup: _t,
            _lookupByKey: yt,
            _rlookupByKey: vt,
            _filterBetween: wt,
            listenArrayEvents: kt,
            unlistenArrayEvents: St,
            _arrayUnique: Pt,
            _createResolver: ni,
            _attachContext: oi,
            _descriptors: ai,
            _parseObjectDataRadialScale: xi,
            splineCurve: vi,
            ...
            _getParentNode: ee,
            getStyle: ne,
            getRelativePosition: re,
            getMaximumSize: he,
            retinaScale: ce,
            supportsEventListenerOptions: de,
            readUsedSize: ue,
        ...
        function ls(t) {
            return !te() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? Xi : rs
        }
        ...
        class Ps {
            ...
            _dataCheck() {
                ...
                if (U(e))
                    ...
                    e && Object.isExtensible(e) && kt(e, this),
                        this._syncList = [],
                        this._data = e
                }
            }
        ...
        const Cs = {
            ...
            logarithmic(t, e, i) {
                if (0 === t)
                    return "0";
                const s = t / Math.pow(10, Math.floor(It(t)));
        ...
        class Bs extends Ds {
            ...
            calculateLabelRotation() {
                ...
                c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)),
                    ...
                    r = Math.sqrt(c * c + d * d),
                    l = $t(Math.min(Math.asin(Zt((h.highest.height + 6) / o, -1, 1)), Math.asin(Zt(a / r, -1, 1)) - Math.asin(Zt(d / r, -1, 1)))),
                    ...
                    $(h) || Y(h)) {
                        if (Y(h))
                            for (r = 0,
                                     l = h.length; r < l; ++r)
                                m = h[r],
                                $(m) || Y(m) || (g = ve(i, u.data, u.gc, g, m),
                                    p += f)
                    } else
                        g = ve(i, u.data, u.gc, g, h),
                            p = f;
                    n.push(g),
                        o.push(p),
                        x = Math.max(g, x),
            ...
            getPixelForDecimal(t) {
                ...
                return Jt(this._alignToPixels ? Me(this.chart, e, 0) : e)
            }
            ...
            drawBorder() {
                ...
                const o = i.setContext(this.getContext(0)).lineWidth
                    , a = this._borderValue;
                let r, l, h, c;
                this.isHorizontal() ? (r = Me(t, this.left, n) - n / 2,
                    l = Me(t, this.right, o) + o / 2,
                    h = c = a) : (h = Me(t, this.top, n) - n / 2,
                    c = Me(t, this.bottom, o) + o / 2,
                    r = l = a),
                    e.save(),
        ...
        class Js {
            ...
            resolveNamedOptions(t, e, i, s = [""]) {
                ...
                let r = o;
                if (function (t, e) {
                    const {isScriptable: i, isIndexable: s} = ai(t);
                    for (const n of e) {
                        const e = i(n)
                            , o = s(n)
                            , a = (o || e) && t[n];
                    ...
                    n.$shared = !1;
                    r = oi(o, i = dt(i) ? i() : i, this.createResolver(t, i, a))
                }
                for (const t of e)
                    n[t] = r[t];
                return n
        ...
        function rn(t) {
            return te() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        class dn {
            ...
            clear() {
                return ke(this.canvas, this.ctx),
                    this
            }
            ...
            _resize(t, e) {
                ...
                this.width = o.width,
                    ...
                    this._aspectRatio = this.aspectRatio,
                ce(this, a, !0) && (this.notifyPlugins("resize", {
                    size: o
                }),
            ...
            _drawDataset(t) {
                ...
                !1 !== this.notifyPlugins("beforeDatasetDraw", o) && (s && De(e, {
            ...
            getContext() {
                return this.$context || (this.$context = $e(null, {
                    chart: this,
                    type: "chart"
                }))
            }
        ...
        function xn(t) {
            const e = t.iScale
                ...
                if (!t._cache.$bar) {
                    ...
                    t._cache.$bar = Pt(s.sort(((t, e) => t - e)))
                }
                return t._cache.$bar
            }(e, t.type);
        ...
        class Sn extends Ps {
            ...
            _calculateBarValuePixels(t) {
                ...
                Math.abs(c) < n) {
                    c = function (t, e, i) {
                        return 0 !== t ? zt(t) : (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1)
                    }(c, e, o) * n,
                    d === o && (p -= c / 2);
                ...
                if (p === e.getPixelForValue(o)) {
                    const t = zt(c) * e.getLineWidthForValue(o) / 2;
                    p += t,
                        c -= t
                }
                return {
        ...
        class Dn extends Ps {
                ...
                const e = this.chart
                    ...
                    if (e < Ct) {
                        const r = t
                            ...
                            , d = Math.cos(l)
                            , u = Math.sin(l)
                            , f = (t, e, s) => Gt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i)
                            , g = (t, e, s) => Gt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i)
                            , p = f(0, h, d)
                            , m = f(Lt, c, u)
                            , x = g(Dt, h, d)
                            , b = g(Dt + Lt, c, u);
            ...
            _circumference(t, e) {
                ...
                return e && i.animation.animateRotate || !this.chart.getDataVisibility(t) || null === s._parsed[t] || s.data[t].hidden ? 0 : this.calculateCircumference(s._parsed[t] * n / Ct)
            }
            ...
            update(t) {
                ...
                let {start: a, count: r} = function (t, e, i) {
                    ...
                    if (t._sorted) {
                        ...
                        d && (n = Zt(Math.min(yt(r, a.axis, h).lo, i ? s : yt(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                            o = u ? Zt(Math.max(yt(r, a.axis, c).hi + 1, i ? 0 : yt(e, l, a.getPixelForValue(c)).hi + 1), n, s) - n : s - n
                    }
                    return {
                        start: n,
                        count: o
        ...
        function En(t, e, i) {
            ...
            t.beginPath(),
                t.arc(o, a, r, s - h, i + h),
                l > n ? (h = n / l,
                    t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + Lt, s - Lt),
                t.closePath(),
                t.clip()
        }

        function In(t, e, i, s) {
            const n = Fe(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
            const o = (i - e) / 2
                , a = Math.min(o, s * e / 2)
                , r = t => {
        ...
        function Fn(t, e, i, s, n) {
            ...
            const g = (f - Math.max(.001, f * c - i / Dt) / c) / 2
                , p = r + g + u
                , m = n - g - u
            ...
            b > 0) {
                const e = zn(w, k, o, a);
                t.arc(e.x, e.y, b, k, m + Lt)
            }
            const O = zn(P, m, o, a);
            if (t.lineTo(O.x, O.y),
            y > 0) {
                const e = zn(P, C, o, a);
                t.arc(e.x, e.y, y, m + Lt, C + Math.PI)
            }
            if (t.arc(o, a, d, m - y / d, p + _ / d, !0),
            _ > 0) {
                const e = zn(S, D, o, a);
                t.arc(e.x, e.y, _, D + Math.PI, p - Lt)
            }
            const A = zn(v, p, o, a);
            if (t.lineTo(A.x, A.y),
            x > 0) {
                const e = zn(v, M, o, a);
                t.arc(e.x, e.y, x, p - Lt, M)
            }
            t.closePath()
        }
        ...
        class Vn extends Ds {
            ...
            draw(t) {
                ...
                if (this.pixelMargin = "inner" === e.borderAlign ? .33 : 0,
                    this.fullCircles = i > Ct ? Math.floor(i / Ct) : 0,
        ...
        function jn(t, e, i, s) {
            const {points: n, options: o} = e
                ...
                , c = function (t) {
                return t.stepped ? Oe : t.tension || "monotone" === t.cubicInterpolationMode ? Ae : Nn
            }(o);
        ...
        class so extends Ds {
            ...
            draw(t) {
                const {inflateAmount: e, options: {borderColor: i, backgroundColor: s}} = this
                    ...
                    , a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? Re : eo;
                var r;
                t.save(),
            ...
            beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(((e, n) => {
                        ...
                        let {start: c, count: d} = function (t, e) {
                            ...
                            return l && (n = Zt(yt(e, o.axis, a).lo, 0, i - 1)),
                                s = h ? Zt(yt(e, o.axis, r).hi + 1, n, i) - n : i - n,
                                {
                                    start: n,
                                    count: s
                                }
        ...
        function go(t, e, i) {
            ...
            let n = parseFloat(s);
            return X(n) && Math.floor(n) === n ? function (t, e, i, s) {
                "-" !== t && "+" !== t || (i = e + i);
                if (i === e || i < 0 || i >= s)
                    return !1;
                return i
        ...
        function bo(t) {
            ...
            const n = function (t) {
                if ((t.scale || {}).getPointPositionForValue)
                    return function (t) {
                        const {scale: e, fill: i} = t
                            ...
                            , a = function (t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : U(t) ? t.value : e.getBaseValue(),
                                s
                        }(i, e, o)
                            , r = [];
                        if (s.grid.circular) {
                ...
                return function (t) {
                    const {scale: e = {}, fill: i} = t
                        , s = function (t, e) {
                        let i = null;
                        return "start" === t ? i = e.bottom : "end" === t ? i = e.top : U(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                            i
                    }(i, e);
                    if (X(s)) {
            ...
            return n instanceof xo ? n : uo(n, s)
        }
        ...
        function _o(t, e, i) {
            ...
            s && n.points.length && (De(t, i),
                function (t, e) {
                    const {line: i, target: s, above: n, below: o, area: a, scale: r} = e
                        , l = i._loop ? "angle" : e.axis;
                    t.save(),
                    "x" === l && o !== n && (yo(t, s, a.top),
                        vo(t, {
                            line: i,
                            target: s,
                            color: n,
        ...
        function vo(t, e) {
            const {line: i, target: s, property: n, color: o, scale: a} = e
                ...
                for (const t of s) {
                    ...
                    const h = Wi(e, l);
                    for (const e of h) {
                        const s = lo(i, o[e.start], o[e.end], e.loop)
                            , r = Vi(t, n, s);
                        for (const t of r)
                            a.push({
                                source: t,
                                target: e,
                                start: {
                                    [i]: co(l, s, "start", Math.max)
                                },
                                end: {
                                    [i]: co(l, s, "end", Math.min)
                                }
                            })
                    }
                }
        ...
        var ko = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                for (a = 0; a < s; ++a)
                    l = n[a],
                    l && !1 !== l.fill && (l.fill = fo(n, a, i.propagate))
            },
            beforeDraw(t, e, i) {
        ...
        class Po extends Ds {
            ...
            fit() {
                ...
                const i = t.labels
                    ...
                    , {boxWidth: a, itemHeight: r} = So(i, n);
                let l, h;
                e.font = s.string,
            ...
            _draw() {
                ...
                this.drawTitle(),
                    ...
                    s.lineWidth = .5,
                    s.font = c.string;
                const {boxWidth: m, boxHeight: x, itemHeight: b} = So(r, f)
                    , _ = this.isHorizontal()
                        ...
                        !function (t, e, i) {
                            ...
                            if (s.fillStyle = K(i.fillStyle, l),
                                ...
                                const o = e + Math.max((f - x) / 2, 0)
                                    ...
                                    , r = Ve(i.borderRadius);
                                s.beginPath(),
                                    Object.values(r).some((t => 0 !== t)) ? Re(s, {
                                        x: a,
                                        y: o,
                                        w: m,
                                        h: x,
        ...
        class Co extends Ds {
            ...
            update(t, e) {
                ...
                const n = s * Ne(i.font).lineHeight + this._padding.height;
        ...
        function Bo(t, e, i) {
            ...
            return {
                xAlign: i.xAlign || e.xAlign || Fo(t, e, i, s),
                yAlign: s
            }
        }
        ...
        function Vo(t, e, i, s) {
            const {caretSize: n, caretPadding: o, cornerRadius: a} = t
                , {xAlign: r, yAlign: l} = i
                , h = n + o
                , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Ve(a);
            let g = function (t, e) {
                let {x: i, width: s} = t;
            ...
            return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h) : "left" === r ? g -= Math.max(c, u) + n : "right" === r && (g += Math.max(d, f) + n),
                {
                    x: Zt(g, 0, s.width - e.width),
                    y: Zt(p, 0, s.height - e.height)
                }
        }
        ...
        class jo extends Ds {
            ...
            getBody(t, e) {
                ...
                return Q(t, (t => {
                        const e = {
                            ...
                            , n = Ho(i, t);
                        Ro(e.before, Eo(n.beforeLabel.call(this, t))),
                            Ro(e.lines, n.label.call(this, t)),
                            Ro(e.after, Eo(n.afterLabel.call(this, t))),
                            s.push(e)
                    }
                )),
                    s
            ...
            getCaretPosition(t, e, i) {
                const {xAlign: s, yAlign: n} = this
                    ...
                    , {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = Ve(a)
                    , {x: d, y: u} = t
                    , {width: f, height: g} = e;
                let p, m, x, b, _, y;
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Wo(this, i.titleAlign, i),
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Wo(this, i.footerAlign, i),
            ...
            drawBackground(t, e, i, s) {
                const {xAlign: n, yAlign: o} = this
                    , {x: a, y: r} = t
                    , {width: l, height: h} = i
                    , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Ve(s.cornerRadius);
        ...
        class Xo extends Bs {
            ...
            parse(t, e) {
                ...
                return ((t, e) => null === t ? null : Zt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Uo(i, t, K(e, t), this._addedLabels), i.length - 1)
            }
        ...
        function qo(t, e, {horizontal: i, minRotation: s}) {
            const n = jt(s)
        ...
        Xo.id = "category",
            Xo.defaults = {
                ticks: {
                    callback: Xo.prototype.getLabelForValue
                }
            };
                ...
                const s = function (t, e) {
                    ...
                    $(r) || (y = Math.pow(10, r),
                        ...
                        "ticks" === s ? (v = Math.floor(g / k) * k,
                            ...
                            w = p),
                        m && x && n && Nt((a - o) / n, k / 1e3) ? (M = Math.round(Math.min((a - o) / k, h)),
                            k = (a - o) / M,
                            v = o,
                            w = a) : b ? (v = m ? o : v,
                            w = x ? a : w,
                    ...
                    v < o && P++,
                    Wt(Math.round((v + P * k) * y) / y, o, qo(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                        i.push({
                            value: Math.round((v + P * k) * y) / y
                        });
                    return x && d && w !== a ? i.length && Wt(i[i.length - 1].value, a, qo(a, _, t)) ? i[i.length - 1].value = a : i.push({
                        value: a
                    }) : x && w !== a || i.push({
                        value: w
                    }),
        ...
        function Zo(t) {
            return 1 === t / Math.pow(10, Math.floor(It(t)))
        }
        ...
        class Jo extends Bs {
            ...
            handleTickRangeOptions() {
                ...
                const n = e => i = t ? i : e
                    , o = t => s = e ? s : t
                    , a = (t, e) => Math.pow(10, Math.floor(It(t)) + e);
                i === s && (i <= 0 ? (n(1),
                    o(10)) : (n(a(i, -1)),
                    o(a(s, 1)))),
                i <= 0 && n(a(s, -1)),
            ...
            buildTicks() {
                const t = this.options
                    , e = function (t, e) {
                    const i = Math.floor(It(e.max))
                        , s = Math.ceil(e.max / Math.pow(10, i))
                        , n = [];
                    let o = q(t.min, Math.pow(10, Math.floor(It(e.min))))
                        , a = Math.floor(It(o))
            ...
            getPixelForValue(t) {
                return void 0 !== t && 0 !== t || (t = this.min),
                    null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (It(t) - this._startValue) / this._valueRange)
            }
        ...
        function ea(t) {
            ...
            for (let d = 0; d < o; d++) {
                ...
                s[d] = g;
                const p = Kt(t.getIndexAngle(d) + r)
                    , m = Math.round($t(p));
                ia(i, e, p, ta(m, u.x, g.w, 0, 180), ta(m, u.y, g.h, 90, 270))
            }
            var l, h, c;
            t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                t._pointLabelItems = function (t, e, i) {
                    const s = []
                        ...
                        , a = Qo(o) / 2
                        , r = t.drawingArea
                        , l = o.pointLabels.centerPointLabels ? Dt / n : 0;
                    for (let o = 0; o < n; o++) {
                        const n = t.getPointPosition(o, r + a + i[o], l)
                            , h = Math.round($t(Kt(n.angle + Lt)))
                            , c = e[o]
                            , d = oa(n.y, c.h, h)
                            , u = sa(h)
                            , f = na(n.x, c.w, u);
        ...
        function aa(t, e, i, s) {
            const {ctx: n} = t;
            if (i)
                n.arc(t.xCenter, t.yCenter, e, 0, Ct);
            else {
        ...
        class ra extends Ko {
            ...
            setDimensions() {
                const t = this._padding = We(Qo(this.options) / 2)
            ...
            generateTickLabels(t) {
                Ko.prototype.generateTickLabels.call(this, t),
            ...
            fit() {
                const t = this.options;
                t.display && t.pointLabels.display ? ea(this) : this.setCenterPoint(0, 0, 0, 0)
            }
            ...
            getIndexAngle(t) {
                return Kt(t * (Ct / (this._pointLabels.length || 1)) + jt(this.options.startAngle || 0))
            }
            ...
            drawBackground() {
                ...
                if (t) {
                    ...
                    i.save(),
                        i.beginPath(),
                        aa(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                        i.closePath(),
                        i.fillStyle = t,
                        i.fill(),
                        i.restore()
        ...
        function da(t, e) {
            ...
            X(a) || (a = "string" == typeof s ? i.parse(a, s) : i.parse(a)),
                null === a ? null : (n && (a = "week" !== n || !Vt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
                    +a)
        }
        ...
        class pa extends Bs {
            ...
            buildTicks() {
                ...
                const n = this.min
                    , o = wt(s, n, this.max);
                return this._unit = e.unit || (i.autoSkip ? ua(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
                    for (let o = ha.length - 1; o >= ha.indexOf(i); o--) {
                        const i = ha[o];
                        if (la[i].common && t._adapter.diff(n, s, i) >= e - 1)
                            return i
                    }
            ...
            _generate() {
                ...
                for (c = u,
                         ...
                         d++)
                    fa(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || fa(h, c, f),
            ...
            _getLabelCapacity(t) {
                const e = this.options.time
                    ...
                    , n = this._tickFormatFunction(t, 0, ga(this, [t], this._majorUnit), s)
        ...
        function ma(t, e, i) {
            ...
            i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = yt(t, "pos", e)),
                ({pos: s, time: o} = t[r]),
                ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = yt(t, "time", e)),
                ({time: s, pos: o} = t[r]),
                ({time: n, pos: a} = t[l]));
            const h = n - s;
        ...
        return dn.register(Rn, ba, no, Yo),
            dn.helpers = {
                ...Yi
            },
            dn._adapters = mn,
            ...
            dn.Scale = Bs,
            dn.Ticks = Os,
            Object.assign(dn, Rn, ba, no, Yo, hs),
            dn.Chart = dn,
